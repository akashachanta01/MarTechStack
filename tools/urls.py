...
urlpatterns = [
    ...
    path('api/ats-match/', views.api_ats_match, name='api_ats_match'),
    path('api/resume/upload/', views.api_resume_upload, name='api_resume_upload'),
    path('api/resume/delete/', views.api_resume_delete, name='api_resume_delete'),
    path('api/my-matches/', views.api_my_matches, name='api_my_matches'),
    path('api/tailor/', views.api_tailor, name='api_tailor'),
    path('api/tailor/docx/', views.api_tailor_docx, name='api_tailor_docx'),
