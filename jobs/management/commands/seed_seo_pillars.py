    ...
    def handle(self, *args, **options):
        ...
        pillars = [
            ...
            (
                ...
                "Braze Jobs",
                "<p>Looking for <strong>Braze jobs</strong>? While Braze itself is a great company, thousands of high-growth brands use Braze and need specialized talent. Find <strong>Braze Email Specialist</strong> and Technologist roles below.</p>"
            ),
            (
                ...
                "Klaviyo Jobs",
                "<p>The best <strong>Klaviyo jobs</strong> for eCommerce growth marketers and technical specialists working with the leading eComm data platform.</p>"
            ),
            (
                ...
                "<p>Browse high-paying <strong>Adobe Experience Platform jobs</strong>. Find technical AEP Architect and Data Engineer roles within the Adobe Experience Cloud ecosystem.</p>"
            ),
            (
            ...
            (
                ...
                "<p>Use our free <strong>ROAS calculator</strong> to measure the effectiveness of your digital marketing campaigns and calculate your Return on Ad Spend instantly.</p>"
            )
        ]
