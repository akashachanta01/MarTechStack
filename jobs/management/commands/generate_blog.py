...
TOPIC_QUEUE = [
    ...
    {"type": "ai_martech", "topic": "The Great Unstacking: What the 3rd Age of MarTech Means for Your Career", "keyword": "great unstacking martech careers", "angle": "A career-side response to Scott Brinker's March 2026 report 'The New Martech Stack for the AI Age' (chiefmartec, in partnership with Databricks) — attribute it by name and link https://chiefmartec.com. His verified claims to engage (do not invent others): the martech landscape grew from ~150 solutions in 2011 to 15,000+ in 2025; he calls this the '3rd Age of Martech' where the rigid stack dissolves into a 'composable canvas' on a unified data foundation; a 'hypertail' of custom software emerges — apps built by marketing ops 'citizen developers' and even agent-generated code; the analyst's role 'shifts from producing reports to designing the metrics, models, and feedback loops that intelligent systems use'; integration complexity falls from O(n²) point-to-point toward shared-data architectures. THE PIECE: translate each architectural shift into what it means for MOps/MarTech careers — platform-admin skills commoditize, data-foundation/semantic-layer/governance skills appreciate, 'citizen developer' becomes part of the MOps job description. End with which of these signals we can already see in live job listings (hedged, qualitative)."},
    {"type": "ai_martech", "topic": "The MarTech Career Ladder, Redrawn for the AI Era", "keyword": "martech career path ai", "angle": "An original framework: the old ladder (specialist → admin → manager) vs the new one (tool operator → systems designer → AI orchestrator → architecture/governance). Name what to learn at each rung. May reference Scott Brinker's 2026 'composable canvas' / 'Great Unstacking' thesis (chiefmartec) as industry context, with attribution."},
    {"type": "ai_martech", "topic": "Stop Learning Tools, Start Learning Systems", "keyword": "martech skills strategy", "angle": "Opinion piece with a spine: tool certifications depreciate, systems thinking compounds. Data models, integration patterns, and lifecycle logic transfer across every platform; the tool-of-the-month does not. Concrete examples of 'systems' skills and how to build them. Strong supporting context (attribute if used): Brinker's 2026 report argues the stack dissolves into a composable canvas on a unified data foundation, where semantic-layer and data-governance skills are the durable ones."},
    {"type": "ai_martech", "topic": "MarTech Roles That Will Exist in 2028", "keyword": "future martech roles 2028", "angle": "Grounded prediction piece: extrapolate from real, present hiring signals (CDP engineering growth, AI governance requirements, journey orchestration) to roles like AI Campaign Orchestrator, Marketing Data Governance Lead, GTM Systems Architect. Clearly label as prediction; explain the signal behind each. Industry context worth citing (with attribution): Brinker's 2026 'hypertail' thesis — marketing ops as 'citizen developers' building custom apps/agents — implies a builder-flavored MOps role class."},
